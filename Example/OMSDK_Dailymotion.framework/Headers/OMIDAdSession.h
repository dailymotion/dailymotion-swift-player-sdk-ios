 ...
 */
@interface OMIDDailymotionAdSession : NSObject

/**
 *  The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly) OMIDDailymotionAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDDailymotionAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDDailymotionAdSessionContext *)context
