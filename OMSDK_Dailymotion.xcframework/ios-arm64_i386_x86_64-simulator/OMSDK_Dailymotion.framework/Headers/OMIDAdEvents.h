 ...
 */
@interface OMIDDailymotionAdEvents : NSObject
 ...
 */
- (nullable instancetype)initWithAdSession:(nonnull OMIDDailymotionAdSession *)session error:(NSError * _Nullable * _Nullable)error;
 ...
 */
- (BOOL)loadedWithVastProperties:(OMIDDailymotionVASTProperties *_Nonnull)vastProperties
