 ...
 */
@interface OMIDDailymotionAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(OMIDDailymotionPartner *)partner
...
- (nullable instancetype)initWithPartner:(OMIDDailymotionPartner *)partner
                               ...
                               resources:(NSArray<OMIDDailymotionVerificationScriptResource *> *)resources
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
